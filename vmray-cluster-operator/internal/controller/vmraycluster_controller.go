...
//+kubebuilder:rbac:groups=vray.broadcom.com,resources=vmrayclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=vray.broadcom.com,resources=vmrayclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=vray.broadcom.com,resources=vmrayclusters/finalizers,verbs=update
