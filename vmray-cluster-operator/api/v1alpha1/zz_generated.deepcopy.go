...
func (in *HeadNodeConfig) DeepCopyInto(out *HeadNodeConfig) {
	*out = *in
	if in.HeadSetupCommands != nil {
		in, out := &in.HeadSetupCommands, &out.HeadSetupCommands
...
func (in *VMRayClusterStatus) DeepCopyInto(out *VMRayClusterStatus) {
	*out = *in
	if in.CurrentWorkers != nil {
		...
		*out = make([]VMRayWorkerStatus, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMRayWorkerStatus) DeepCopyInto(out *VMRayWorkerStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMRayWorkerStatus.
func (in *VMRayWorkerStatus) DeepCopy() *VMRayWorkerStatus {
	if in == nil {
		return nil
	}
	out := new(VMRayWorkerStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkerNodeConfig) DeepCopyInto(out *WorkerNodeConfig) {
	*out = *in
	if in.WorkerSetupCommands != nil {
		in, out := &in.WorkerSetupCommands, &out.WorkerSetupCommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
